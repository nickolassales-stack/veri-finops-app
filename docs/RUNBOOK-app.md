...
| Valores em USD | Não há regra oficial de conversão para BRL. A aplicação não converte — exibir número financeiro com taxa inventada seria pior que não exibir |
