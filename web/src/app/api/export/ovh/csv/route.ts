...
/**
 * GET /api/export/ovh/csv -- os custos OVH do filtro atual.
 *
...
export const GET = rotaComPermissaoArquivo(
  ...
  async ({ url, tz }) => {
    ...
    return new Response(gerarCSVOvh(linhas, contexto), {
      headers: cabecalhosDeArquivo(
        nomeDoArquivoOvh(periodo.deMes, periodo.ateMes, "csv"),
